...
## Author: sumanth
## Date: March 10,2017
# script implements sliding window
...
# function list windows to be searched (output of slide_windows())
def searchWindows(img, windows, clf, scaler, color_space='RGB',
    ...
    for window in windows:
        ...
        features = hog_features.fetchImgFeatures(test_img, color_space=color_space,
